...
<test>
    ...
    <parameters>KovaFlow_m10_VCSImplicit_MatFree.xml</parameters>
    <files>
        <file description="Session File">KovaFlow_m10_VCSImplicit_MatFree.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
        ...
        <metric type="Linf" id="2">
            <value variable="u" tolerance="5e-08">7.68403e-08</value>
