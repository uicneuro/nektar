...
<test>
    <description>Test different boundary condition enforcements: entropy-pressure </description>
    <executable>CompressibleFlowSolver </executable>
    <parameters>square_mix.xml session_enforceEntropyPressure.xml </parameters>
    <files>
        <file description="Session File">square_mix.xml</file>
        <file description="Session File">session_enforceEntropyPressure.xml</file>
    </files>
    <metrics>
