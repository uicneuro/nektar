...
<test>
    <description>NS, 3D Couette flow with non-conformal translate, exact solution</description>
    ...
    <metrics>
        <metric type="L2" id="1">
            ...
            <value variable="rhow" tolerance="1e-6">4.00691e-13</value>
            <value variable="E" tolerance="1e-6">2.52549e-06</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="rho" tolerance="1e-6">3.37801e-06</value>
            <value variable="rhou" tolerance="1e-6">6.63741e-07</value>
            <value variable="rhov" tolerance="1e-6">5.16763e-06</value>
            <value variable="rhow" tolerance="1e-6">2.29333e-12</value>
            <value variable="E" tolerance="1e-6"> 5.68531e-06</value>
        </metric>
    </metrics>
</test>
