...
<test>
    <description>Test different boundary condition enforcements: entropy-velocity </description>
    <executable>CompressibleFlowSolver </executable>
    <parameters>square_mix.xml session_enforceEntropyVelocity.xml </parameters>
    <files>
        <file description="Session File">square_mix.xml</file>
        <file description="Session File">session_enforceEntropyVelocity.xml</file>
    </files>
    <metrics>
