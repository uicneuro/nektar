...
<test>
    <description>NS, Couette flow with non-conformal translate, exact solution</description>
    ...
    <metrics>
        ...
        <metric type="Linf" id="2">
            ...
            <value variable="rhou" tolerance="1e-6">2.91594e-07</value>
            <value variable="rhov" tolerance="1e-6">8.17435e-07</value>
            <value variable="E" tolerance="1e-6"> 9.08053e-07</value>
        </metric>
    </metrics>
</test>
