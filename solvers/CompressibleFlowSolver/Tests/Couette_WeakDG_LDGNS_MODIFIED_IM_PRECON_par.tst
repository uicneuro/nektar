...
<test>
    <description>NS, Couette flow, mixed bcs, WeakDG advection and LDGNS diffusion, Implicit</description>
    <executable>CompressibleFlowSolver</executable>
    <parameters>Couette_WeakDG_LDGNS_MODIFIED_IM_PRECON.xml</parameters>
    <processes>4</processes>
    <files>
        <file description="Session File">Couette_WeakDG_LDGNS_MODIFIED_IM_PRECON.xml</file>
    </files>
    <metrics>
      <metric type="L2" id="1">
