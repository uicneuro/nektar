...
<test>
    <description>NS, Subsonic Cylinder, mixed bcs, WeakDG advection and LDGNS diffusion, variable viscosity</description>
    <executable>CompressibleFlowSolver</executable>
    <parameters>CylinderSubsonic_NS_WeakDG_LDGNS_SEM_VariableMu.xml</parameters>
    <files>
        <file description="Session File">CylinderSubsonic_NS_WeakDG_LDGNS_SEM_VariableMu.xml</file>
    </files>
    <metrics>
        <metric type="L2" id="1">
