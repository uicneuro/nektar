...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="eta" tolerance="1e-12">0.000869685</value>
            <value variable="u" tolerance="1e-12">0.000513415</value>
            <value variable="v" tolerance="1e-12">0.000513415</value>
        </metric>
