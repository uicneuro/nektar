...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="eta" tolerance="1e-12">1.2625e-08</value>
            <value variable="u" tolerance="1e-12">5.10535e-07</value>
            <value variable="v" tolerance="1e-12">5.10535e-07</value>
        </metric>
