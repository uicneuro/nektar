...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xnekmeshx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE OPTIONAL FILES "/Users/schun/nektar/build/utilities/NekMesh/NekMesh")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/NekMesh" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      -delete_rpath "/Users/schun/nektar/build/library/NekMesh"
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/NekMesh")
    execute_process(COMMAND /usr/bin/install_name_tool
