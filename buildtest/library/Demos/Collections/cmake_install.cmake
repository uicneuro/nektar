# Install script for directory: /Users/schun/nektar/library/Demos/Collections
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "demos" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE OPTIONAL FILES "/Users/schun/nektar/buildtest/library/Demos/Collections/CollectionTiming")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/CollectionTiming" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/CollectionTiming")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/strip" -u -r "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/CollectionTiming")
    endif()
  endif()
endif()
