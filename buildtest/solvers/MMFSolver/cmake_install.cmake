# Install script for directory: /Users/schun/nektar/solvers/MMFSolver
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "mmf-solver" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE OPTIONAL FILES "/Users/schun/nektar/buildtest/solvers/MMFSolver/MMFSolver")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/MMFSolver" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/MMFSolver")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/strip" -u -r "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/MMFSolver")
    endif()
  endif()
endif()
