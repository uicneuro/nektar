# Install script for directory: /Users/schun/nektar/solvers/CompressibleFlowSolver/RiemannSolvers/UnitTests
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "compressibleflow-solver" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE OPTIONAL FILES "/Users/schun/nektar/buildtest/solvers/CompressibleFlowSolver/RiemannSolvers/UnitTests/RiemannCompUnitTests")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/RiemannCompUnitTests" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/RiemannCompUnitTests")
    execute_process(COMMAND /usr/bin/install_name_tool
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/RiemannCompUnitTests")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/strip" -u -r "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/RiemannCompUnitTests")
    endif()
  endif()
endif()
