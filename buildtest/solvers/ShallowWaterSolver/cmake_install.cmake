# Install script for directory: /Users/schun/nektar/solvers/ShallowWaterSolver
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "shallowwater-solver" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE OPTIONAL FILES "/Users/schun/nektar/buildtest/solvers/ShallowWaterSolver/ShallowWaterSolver")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/ShallowWaterSolver" AND
    ...
    execute_process(COMMAND /usr/bin/install_name_tool
      ...
      "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/ShallowWaterSolver")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/strip" -u -r "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/ShallowWaterSolver")
    endif()
  endif()
endif()
